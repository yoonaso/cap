...
var result = {
    ...
    "ES": {
        ...
        "img": "./img/IoT.png",
        "personality": "유행을 중요시해서 신조어나 새로나온<br/>원인을 찾아내서 해결해나가는 편이에요.",
        "personality2": "문제가 생겼을 때 무작정 해결하기 보다는<br/>커뮤니케이션 능력이 뛰어납니다.",
        "personality3": "상상력이 워낙 풍부해서 엉뚱하다는 소리를 듣긴<br/>하지만 특유의 호기심과 상상력으로<br/> 무엇이든 도전해 나갑니다.",
